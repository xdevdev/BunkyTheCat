...
background_lo = pygame.image.load('river.png')
background_loy = pygame.transform.scale(background_lo, (800, 600))
...
bullet_Img2 = pygame.image.load('kratong.png')
bulletImg2 = pygame.transform.scale(bullet_Img2, (75, 75))
...
def game_intro():
    ...
    while intro:
        ...
        button("LOY KRATONG",325,470,150,60,green,brightgreen,game_loop_loy)
        pygame.display.update()
        clock.tick(15)
...
def game_loop_loy():
    ...
    while running:
        ...
        screen.fill(white)
        # Background Image
        screen.blit(background_loy, (0, 0))
        #button("BACK",325,435,150,60,green,brightgreen,game_intro)
            ...
            if event.type == pygame.KEYDOWN:
                ...
                if event.key == pygame.K_SPACE:
                    if bullet_state is "ready":
                        ...
                        # Get the current x cordinate of the spaceship
                        bulletX = playerX
                        fire_bullet_loy(bulletX, bulletY)
